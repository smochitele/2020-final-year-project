...
public class CaseAdapter extends RecyclerView.Adapter<Template> {

    private Context context;
    private ArrayList<Model> models;

    public CaseAdapter(Context context, ArrayList<Model> models) {
        this.models = models;
    ...
    public Template onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cases, null);
